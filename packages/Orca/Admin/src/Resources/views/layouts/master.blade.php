...
<html lang="{{ config('app.locale') }}">
    <head>
        ...
        <link rel="icon" sizes="16x16" href="{{ asset('vendor/orca/ui/assets/images/favicon.ico') }}" />

        <link rel="stylesheet" href="{{ asset('vendor/orca/admin/assets/css/admin.css') }}">
        ...
        {!! view_render_event('orca.admin.layout.head') !!}

    </head>

    <body @if (core()->getCurrentLocale()->direction == 'rtl') class="rtl" @endif style="scroll-behavior: smooth;">
        {!! view_render_event('orca.admin.layout.body.before') !!}

        <div id="app">

            <flash-wrapper ref='flashes'></flash-wrapper>

            {!! view_render_event('orca.admin.layout.nav-top.before') !!}

            @include ('admin::layouts.nav-top')

            {!! view_render_event('orca.admin.layout.nav-top.after') !!}


            {!! view_render_event('orca.admin.layout.nav-left.before') !!}

            @include ('admin::layouts.nav-left')

            {!! view_render_event('orca.admin.layout.nav-left.after') !!}


            <div class="content-container">

                {!! view_render_event('orca.admin.layout.content.before') !!}

                @yield('content-wrapper')

                {!! view_render_event('orca.admin.layout.content.after') !!}
        ...
        <script type="text/javascript" src="{{ asset('vendor/orca/admin/assets/js/admin.js') }}"></script>
        ...
        {!! view_render_event('orca.admin.layout.body.after') !!}
