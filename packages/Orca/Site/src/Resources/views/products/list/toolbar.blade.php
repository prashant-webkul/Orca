...
{!! view_render_event('orca.site.products.list.toolbar.before') !!}

<div class="top-toolbar mb-35">

    <div class="page-info">
        <span>
            {{ __('site::app.products.pager-info', ['showing' => $products->firstItem() . '-' . $products->lastItem(), 'total' => $products->total()]) }}
        </span>
    ...
    <div class="pager">
        ...
        <div class="sorter">
            <label>{{ __('site::app.products.sort-by') }}</label>
        ...
        <div class="limiter">
            <label>{{ __('site::app.products.show') }}</label>
...
{!! view_render_event('orca.site.products.list.toolbar.after') !!}
