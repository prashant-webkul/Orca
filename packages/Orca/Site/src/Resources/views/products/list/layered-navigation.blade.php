@inject ('attributeRepository', 'Orca\Attribute\Repositories\AttributeRepository')

@inject ('productFlatRepository', 'Orca\Product\Repositories\ProductFlatRepository')
...
<div class="layered-filter-wrapper">
    ...
    {!! view_render_event('orca.site.products.list.layered-nagigation.before') !!}

    <layered-navigation></layered-navigation>

    {!! view_render_event('orca.site.products.list.layered-nagigation.after') !!}
    ...
    <script type="text/x-template" id="layered-navigation-template">
        <div>
            ...
            <div class="filter-title">
                {{ __('site::app.products.layered-nav-title') }}
            </div>
            ...
            <div class="filter-attributes-title" @click="active = !active">
                ...
                <div class="pull-right">
                    <span class="remove-filter-link" v-if="appliedFilters.length" @click.stop="clearFilters()">
                        {{ __('site::app.products.remove-filter-link-title') }}
                    </span>
