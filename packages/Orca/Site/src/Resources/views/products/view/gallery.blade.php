...
{!! view_render_event('orca.site.products.view.gallery.before', ['product' => $product]) !!}
...
<div class="product-image-group">
    ...
    @include ('site::products.view.product-add')

</div>

{!! view_render_event('orca.site.products.view.gallery.after', ['product' => $product]) !!}
