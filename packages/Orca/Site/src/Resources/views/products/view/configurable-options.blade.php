@if ($product->type == 'configurable')
    ...
    @inject ('configurableOptionHelper', 'Orca\Product\Helpers\ConfigurableOption')

    {!! view_render_event('orca.site.products.view.configurable-options.before', ['product' => $product]) !!}

    <product-options></product-options>

    {!! view_render_event('orca.site.products.view.configurable-options.after', ['product' => $product]) !!}
            ...
            <div class="attributes">
                ...
                <div v-for='(attribute, index) in childAttributes' class="attribute control-group" :class="[errors.has('super_attribute[' + attribute.id + ']') ? 'has-error' : '']">
                    ...
                    <span class="swatch-container" v-else>
                        ...
                        <span v-if="! attribute.options.length" class="no-options">{{ __('site::app.products.select-above-options') }}</span>
                    </span>
