...
@section('page_title')
    {{ __('site::app.reviews.add-review-page-title') }} - {{ $product->name }}
@endsection
    ...
    <section class="review">
        ...
        <div class="review-layouter mb-20">
            <div class="product-info">
                ...
                @include('site::products.review-price')

            </div>

            <div class="review-form">
                <form method="POST" action="{{ route('Site.reviews.store', $product->product_id ) }}" @submit.prevent="onSubmit">
                    @csrf

                    <div class="heading mt-10 mb-25">
                        <span>{{ __('site::app.reviews.write-review') }}</span>
                    </div>
