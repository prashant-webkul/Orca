    ...
    <div style="padding: 30px;">
        <div style="font-size: 20px;color: #242424;line-height: 30px;margin-bottom: 34px;">
            <span style="font-weight: bold;">
                {{ __('site::app.mail.order.heading') }}
            </span> <br>

            <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
                {{ __('site::app.mail.order.dear', ['audience_name' => $order->audience_full_name]) }},
            </p>

            <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
                {!! __('site::app.mail.order.greeting', [
        ...
        <div style="font-weight: bold;font-size: 20px;color: #242424;line-height: 30px;margin-bottom: 20px !important;">
            {{ __('site::app.mail.order.summary') }}
        </div>

        <div style="display: flex;flex-direction: row;margin-top: 20px;justify-content: space-between;margin-bottom: 40px;">
            <div style="line-height: 25px;">
                <div style="font-weight: bold;font-size: 16px;color: #242424;">
                    {{ __('site::app.mail.order.shipping-address') }}
                </div>
                ...
                <div style="margin-bottom: 40px;">
                    {{ __('site::app.mail.order.contact') }} : {{ $order->shipping_address->phone }}
                </div>

                <div style="font-size: 16px;color: #242424; font-weight: bold">
                    {{ __('site::app.mail.order.shipping') }}
                </div>
            ...
            <div style="line-height: 25px;">
                <div style="font-weight: bold;font-size: 16px;color: #242424;">
                    {{ __('site::app.mail.order.billing-address') }}
                </div>
                ...
                <div style="margin-bottom: 40px;">
                    {{ __('site::app.mail.order.contact') }} : {{ $order->billing_address->phone }}
                </div>

                <div style="font-size: 16px; color: #242424; font-weight: bold">
                    {{ __('site::app.mail.order.payment') }}
                </div>
                    ...
                    <tbody>
                        @foreach ($order->items as $item)
                            <tr>
                                ...
                                <td data-value="{{ __('site::app.audience.account.order.view.price') }}" style="text-align: left;padding: 8px">{{ core()->formatPrice($item->price, $order->order_currency_code) }}
                                </td>

                                <td data-value="{{ __('site::app.audience.account.order.view.qty') }}" style="text-align: left;padding: 8px">{{ $item->qty_ordered }}</td>
        ...
        <div style="font-size: 16px;color: #242424;line-height: 30px;float: right;width: 40%;margin-top: 20px;">
            <div>
                <span>{{ __('site::app.mail.order.subtotal') }}</span>
            ...
            <div>
                <span>{{ __('site::app.mail.order.shipping-handling') }}</span>
                <span style="float: right;">
            ...
            <div>
                <span>{{ __('site::app.mail.order.tax') }}</span>
                <span style="float: right;">
            ...
            @if ($order->discount_amount > 0)
                <div>
                    <span>{{ __('site::app.mail.order.discount') }}</span>
                    <span style="float: right;">
            ...
            <div style="font-weight: bold">
                <span>{{ __('site::app.mail.order.grand-total') }}</span>
                <span style="float: right;">
        ...
        <div style="margin-top: 65px;font-size: 16px;color: #5E5E5E;line-height: 24px;display: inline-block">
            <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
                {{ __('site::app.mail.order.final-summary') }}
            </p>

            <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
                {!!
                    __('site::app.mail.order.help', [
