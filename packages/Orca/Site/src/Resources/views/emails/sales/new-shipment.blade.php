    ...
    <div style="padding: 30px;">
        <div style="font-size: 20px;color: #242424;line-height: 30px;margin-bottom: 34px;">
            <span style="font-weight: bold;">
                {{ __('site::app.mail.shipment.heading', ['order_id' => $order->id, 'shipment_id' => $shipment->id]) }}
            </span> <br>
        ...
        <div style="font-weight: bold;font-size: 20px;color: #242424;line-height: 30px;margin-bottom: 20px !important;">
            {{ __('site::app.mail.shipment.summary') }}
        </div>
            ...
            <div style="line-height: 25px;">
                ...
                <div style="font-size: 16px;color: #242424;">
                    ...
                    <div style="margin-top: 5px;">
                        <span style="font-weight: bold;">{{ __('site::app.mail.shipment.carrier') }} : </span>{{ $shipment->carrier_title }}
                    </div>

                    <div style="margin-top: 5px;">
                        <span style="font-weight: bold;">{{ __('site::app.mail.shipment.tracking-number') }} : </span>{{ $shipment->track_number }}
                    </div>
                </div>
            </div>
