...
use Orca\Core\Repositories\ExchangeRateRepository;
use Orca\Core\Repositories\CountryRepository;
use Orca\Core\Repositories\CountryStateRepository;
use Orca\Core\Repositories\ChannelRepository;
use Orca\Core\Repositories\LocaleRepository;
use Orca\Core\Repositories\CoreConfigRepository;
...
class Core
{
     ...
     *
     * @param  Orca\Core\Repositories\ChannelRepository      $channelRepository
     * @param  Orca\Core\Repositories\CurrencyRepository     $currencyRepository
     * @param  Orca\Core\Repositories\ExchangeRateRepository $exchangeRateRepository
     * @param  Orca\Core\Repositories\CountryRepository      $countryRepository
     * @param  Orca\Core\Repositories\CountryStateRepository $countryStateRepository
     * @param  Orca\Core\Repositories\LocaleRepository       $localeRepository
     * @param  Orca\Core\Repositories\CoreConfigRepository   $coreConfigRepository
     * @return void
     */
