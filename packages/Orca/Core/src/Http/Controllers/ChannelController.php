...
class ChannelController extends Controller
{
    ...
    public function store()
    {
        $this->validate(request(), [
            'code' => ['required', 'unique:channels,code', new \Orca\Core\Contracts\Validations\Code],
            'name' => 'required',
    ...
    {
        $this->validate(request(), [
            'code' => ['required', 'unique:channels,code,' . $id, new \Orca\Core\Contracts\Validations\Code],
            'name' => 'required',
            'locales' => 'required|array|min:1',
