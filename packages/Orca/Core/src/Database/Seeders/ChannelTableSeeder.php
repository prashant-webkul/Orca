...
class ChannelTableSeeder extends Seeder
{
    public function run()
    {
        ...
        DB::table('channels')->insert([
                ...
                'name' => 'Default',
                'root_category_id' => 1,
                'home_page_content' => '<p>@include("site::home.slider") @include("site::home.featured-products") @include("site::home.new-products")</p><div class="banner-container"><div class="left-banner"><img src="https://s3-ap-southeast-1.amazonaws.com/cdn.uvdesk.com/website/1/201902045c581f9494b8a1.png" /></div><div class="right-banner"><img src="https://s3-ap-southeast-1.amazonaws.com/cdn.uvdesk.com/website/1/201902045c581fb045cf02.png" /> <img src="https://s3-ap-southeast-1.amazonaws.com/cdn.uvdesk.com/website/1/201902045c581fc352d803.png" /></div></div>',
